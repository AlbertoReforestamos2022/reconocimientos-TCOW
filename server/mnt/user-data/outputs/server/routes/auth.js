...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    // Si se proporcionó city_id, verificar que existe
    if (city_id) {
    ...
    // Obtener datos del usuario + ciudad para el token
...
// ─── GET /api/auth/me ─────────────────────────────────────────────────────────
// Devuelve los datos del usuario logueado (útil para refrescar el estado en el frontend)
